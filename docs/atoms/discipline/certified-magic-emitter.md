...
| Magic code generator handlers (V1 shipped, S5.0.2) | `@@template` / `@@expand` / `@@import` per [PLAN-S5.0.2](../../notebook/PLAN-S5.0.2-magic-code-generators.md) | new cells inserted after the generator cell | `emit_magic_line()`; mandatory `generated_by` provenance |
...
- **V1 (post-S5.0.2)**: generator handlers ship per [PLAN-S5.0.2](../../notebook/PLAN-S5.0.2-magic-code-generators.md).
