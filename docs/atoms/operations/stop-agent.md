...
**Source specs**: [BSP-002 §3](../../notebook/BSP-002-conversation-graph.md#3-cell-directive-grammar) (directive grammar; `/stop`), [BSP-002 §4.3](../../notebook/BSP-002-conversation-graph.md#43-idle-exit) (idle exit lifecycle)
