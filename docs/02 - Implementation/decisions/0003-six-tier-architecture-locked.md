...
The full ASCII stack diagram and the detailed top-down/bottom-up event walks live in [chapter 03](../../01%20-%20Design/dev-guide/03-hypergraph-observability.md) and are not reproduced here.
...
- **Dev guide:** [chapter 03 — Hypergraph observability architecture](../../01%20-%20Design/dev-guide/03-hypergraph-observability.md)
