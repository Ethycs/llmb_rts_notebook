...
**Source specs**: [BSP-002 §2.1](../../../03%20-%20Blueprint/BSP-002-conversation-graph.md#21-turn) (turn schema), [BSP-002 §6](../../../03%20-%20Blueprint/BSP-002-conversation-graph.md#6-cell--turn-binding-and-cell-as-agent-identity) (binding rule), [BSP-005 §S5.0](../../../03%20-%20Blueprint/BSP-005-cell-roadmap.md) (cell-magic vocabulary), [PLAN-S5.0-cell-magic-vocabulary.md §3.5](../../../07%20-%20Status%20Reports/PLAN-S5.0-cell-magic-vocabulary.md#35-schema-simplification--vendorllmkernelllm_kernelmetadata_writerpy-modest) (schema collapse), [KB-notebook-target.md §4](../../../03%20-%20Blueprint/KB-notebook-target.md#4-what-a-cell-is) (philosophical frame), [KB-notebook-target.md §0.4](../../../03%20-%20Blueprint/KB-notebook-target.md#04-cell-kinds-typed-in-v1) (typed kind)
...
- **One cell, one kind.** Declared by at most one `@@<cell_magic>` line at the top of `text`; a second `@@<known>` declaration raises K30. The kind is enforced at parse time so [merge invariants](../../../03%20-%20Blueprint/KB-notebook-target.md#221-splitmerge-invariants) (`same primary cell kind`) work from V1.
...
- **One cell, one bound agent (when `kind=agent`).** Multi-agent transcripts require multiple cells. Cell-as-agent-identity ([BSP-002 §6](../../../03%20-%20Blueprint/BSP-002-conversation-graph.md#6-cell--turn-binding-and-cell-as-agent-identity)) renders the badge so the operator never has to read the directive to know who ran here.
...
- **V2+**: kinds `tool`, `artifact`, `control`, `native` activate. `capabilities[]` populated with permission tokens per [KB-notebook-target.md §20](../../../03%20-%20Blueprint/KB-notebook-target.md#20-security-and-capabilities). Section nesting unlocks.
