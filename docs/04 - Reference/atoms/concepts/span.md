...
**Source specs**: [BSP-002 §2.1](../../../03%20-%20Blueprint/BSP-002-conversation-graph.md#21-turn) (turns carry spans[]), [BSP-002 §13.4.1](../../../03%20-%20Blueprint/BSP-002-conversation-graph.md#1341-rule--agent-initiated-tool-calls), [RFC-006 §1](../../../05%20-%20Standards/rfcs/RFC-006-kernel-extension-wire-format.md) (Family A wire)
...
| `system_message` | Kernel- or system-injected context (e.g., cross-agent handoff content per [BSP-002 §4.6](../../../03%20-%20Blueprint/BSP-002-conversation-graph.md#46-cross-agent-context-handoff)). |
...
- **Self-describing on the wire.** No envelope. The OTLP shape IS the contract ([RFC-006 §1](../../../05%20-%20Standards/rfcs/RFC-006-kernel-extension-wire-format.md)). `display_id == spanId` is the routing key.
