...
**Source specs**: [BSP-002 §8.2](../../../03%20-%20Blueprint/BSP-002-conversation-graph.md#82-schema) (storage layout), [BSP-002 §13.5.3](../../../03%20-%20Blueprint/BSP-002-conversation-graph.md#1353-artifactref-shape-on-metadatartszoneblobssha256-kb-target-09), [KB-notebook-target.md §19](../../../03%20-%20Blueprint/KB-notebook-target.md#19-persistence-model) (blobs in the persistence model)
...
- **V2+**: `body: null` permitted; the streaming materializer adds the indices and windows ([KB-target §16](../../../03%20-%20Blueprint/KB-notebook-target.md#16-artifact-streaming) — `byte_index`, `line_index`, `semantic_index`, `loaded_windows`, `pinned_ranges`, `summaries`). The blob outer shape is unchanged; new fields are additive.
