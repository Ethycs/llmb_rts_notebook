...
**V1 ships the `llmnb.output.kind` OTLP attribute. V2 ships the lens UI** that filters spans by it. Per [KB-target §0.8](../../../03%20-%20Blueprint/KB-notebook-target.md#08-typed-outputs--v1-ships-the-tag-v2-ships-lenses) and [BSP-002 §13.5.2](../../../03%20-%20Blueprint/BSP-002-conversation-graph.md#1352-otlp-attribute-llmnboutputkind-kb-target-08--v1-tag-v2-lenses):
...
3. **Wire-additive only.** [BSP-002 §13.5.2](../../../03%20-%20Blueprint/BSP-002-conversation-graph.md#1352-otlp-attribute-llmnboutputkind-kb-target-08--v1-tag-v2-lenses) confirms: RFC-006 §1's mandatory attributes don't change; this is one new optional attribute. No existing wire consumer breaks.
