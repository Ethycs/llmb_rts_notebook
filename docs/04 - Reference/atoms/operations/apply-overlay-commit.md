...
**Status**: V1 shipped — intent kind registered per G2 + `OverlayApplier` module per G8 (both in [PLAN-substrate-gap-closure.md](../../../07%20-%20Status%20Reports/PLAN-substrate-gap-closure.md), submodule `bf0cf16` + outer `92c7412`); atomic-apply, K90 rollback, K91 unreachable, K92 ref conflict, K93 merge precondition, K94 split precondition, K95 in-flight execution all covered by 7 §9 tests in `test_overlay_applier.py`
**Source specs**: [BSP-007 §4.1](../../../03%20-%20Blueprint/BSP-007-overlay-git-semantics.md#41-apply_commitoperations--new_commit_id) (primitive), [BSP-007 §2.1](../../../03%20-%20Blueprint/BSP-007-overlay-git-semantics.md#21-overlaycommit) (commit data model), [BSP-007 §8](../../../03%20-%20Blueprint/BSP-007-overlay-git-semantics.md#8-wire-integration) (wire integration), [BSP-003 §5](../../../03%20-%20Blueprint/BSP-003-writer-registry.md) (intent registry — `apply_overlay_commit`)
