...
**Status**: V1 shipped — intent kind registered per G2 + `OverlayApplier` module per G8 (both in [PLAN-substrate-gap-closure.md](../../../06%20-%20Roadmaps/PLAN-substrate-gap-closure.md), submodule `bf0cf16` + outer `92c7412`); atomic-apply, K90 rollback, K91 unreachable, K92 ref conflict, K93 merge precondition, K94 split precondition, K95 in-flight execution all covered by 7 §9 tests in `test_overlay_applier.py`
