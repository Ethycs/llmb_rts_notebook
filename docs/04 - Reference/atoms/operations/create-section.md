...
**Source specs**: [BSP-007 §3.3](../../../03%20-%20Blueprint/BSP-007-overlay-git-semantics.md#33-section-level-new-per-kb-target-01-kb-target-6) (operation), [BSP-002 §13.1.1](../../../03%20-%20Blueprint/BSP-002-conversation-graph.md#1311-schema--metadatartszonesections) (section schema), [PLAN-atom-refactor.md §4 rows D3, SD3](../../../07%20-%20Status%20Reports/PLAN-atom-refactor.md#4-the-24-v1-decisions-to-land-in-decisions-atoms)
