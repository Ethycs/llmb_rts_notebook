...
**Source specs**: [RFC-006 §1](../../../05%20-%20Standards/rfcs/RFC-006-kernel-extension-wire-format.md#1--family-a-run-lifecycle-otlpjson-over-iopub), [RFC-005 §`metadata.rts.event_log`](../../../05%20-%20Standards/rfcs/RFC-005-llmnb-file-format.md#metadatartsevent_log--chat-flow), [BSP-002 §13.5.2](../../../03%20-%20Blueprint/BSP-002-conversation-graph.md#1352-otlp-attribute-llmnboutputkind-kb-target-08--v1-tag-v2-lenses)
