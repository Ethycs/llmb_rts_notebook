...
**Source specs**: [RFC-006 §4](../../../05%20-%20Standards/rfcs/RFC-006-kernel-extension-wire-format.md#4--family-b-layout), [RFC-005 §`metadata.rts.layout`](../../../05%20-%20Standards/rfcs/RFC-005-llmnb-file-format.md#metadatartslayout--layout-tree)
...
Both messages travel inside the [thin Comm envelope](../../../05%20-%20Standards/rfcs/RFC-006-kernel-extension-wire-format.md#3--comm-envelope-thin) (`{type, payload, correlation_id?}`).
