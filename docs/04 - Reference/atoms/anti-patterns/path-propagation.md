...
**Source specs**: [RFC-009 §4.2](../../../05%20-%20Standards/rfcs/RFC-009-zone-control-and-config.md), [RFC-009 §11](../../../05%20-%20Standards/rfcs/RFC-009-zone-control-and-config.md)
...
[RFC-009 §4.2](../../../05%20-%20Standards/rfcs/RFC-009-zone-control-and-config.md) specifies the discovery contract for any binary the kernel spawns. Per-setting precedence for file paths:
...
- Extension preflight (per [RFC-009 §10 step 6](../../../05%20-%20Standards/rfcs/RFC-009-zone-control-and-config.md)) — mirrors §4.2, exports `LLMNB_CLAUDE_BIN` to `process.env` before any kernel spawn.
...
- [RFC-009 §4.2](../../../05%20-%20Standards/rfcs/RFC-009-zone-control-and-config.md) — the discovery contract.
- [RFC-009 §11](../../../05%20-%20Standards/rfcs/RFC-009-zone-control-and-config.md) — "Every config-class anti-pattern this project has hit could be re-cast as 'a setting was read from a source the operator didn't expect to win.'"
