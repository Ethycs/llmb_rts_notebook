...
**Source specs**: [Engineering Guide §11.8](../../../../Engineering_Guide.md#118-vs-code-configuration-priority--workspace-beats-global), [RFC-009 §11](../../../05%20-%20Standards/rfcs/RFC-009-zone-control-and-config.md)
...
[RFC-009](../../../05%20-%20Standards/rfcs/RFC-009-zone-control-and-config.md) was drafted in part to pin the precedence order so this whole class becomes a question we never have to answer ad-hoc again. See [RFC-009 §11](../../../05%20-%20Standards/rfcs/RFC-009-zone-control-and-config.md): *"Every config-class anti-pattern this project has hit could be re-cast as 'a setting was read from a source the operator didn't expect to win.'"*
...
- [RFC-009 §11](../../../05%20-%20Standards/rfcs/RFC-009-zone-control-and-config.md) — the broader zone-control precedence framework that prevents this whole class.
