...
**Source specs**: [BSP-004 V1.x retrospective](../../../03%20-%20Blueprint/BSP-004-kernel-runtime.md), [BSP-006 §4](../../../03%20-%20Blueprint/BSP-006-embedded-asgi.md)
...
Per [BSP-004 V1.x retrospective](../../../03%20-%20Blueprint/BSP-004-kernel-runtime.md): the V1 runtime swap (uvicorn lifespan running `_run_read_loop` in a thread-pool executor) regressed Tier 4 e2e. Marker file showed:
...
- [BSP-004 V1.x retrospective](../../../03%20-%20Blueprint/BSP-004-kernel-runtime.md) — the failure narrative.
- [BSP-006 §4](../../../03%20-%20Blueprint/BSP-006-embedded-asgi.md) — the V3 design that depends on this fix being in place.
