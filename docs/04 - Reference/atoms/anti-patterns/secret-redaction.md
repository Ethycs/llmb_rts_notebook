...
**Source specs**: [RFC-009 §4.4](../../../05%20-%20Standards/rfcs/RFC-009-zone-control-and-config.md), [Engineering Guide §11.5](../../../../Engineering_Guide.md#115-editing-intermediate-files-instead-of-the-canonical-doc)
...
Per [RFC-009 §4.4](../../../05%20-%20Standards/rfcs/RFC-009-zone-control-and-config.md):
...
4. **K82 surfaces the violation.** Per [RFC-009 §8](../../../05%20-%20Standards/rfcs/RFC-009-zone-control-and-config.md): `zone_control_forbidden_secret` with `setting_name`, `source` is a kernel-fatal at agent-spawn time. The supervisor refuses to spawn if a secret was sourced from a non-env place.
...
- [RFC-009 §4.4](../../../05%20-%20Standards/rfcs/RFC-009-zone-control-and-config.md) — the env-only rule for credentials.
- [RFC-009 §8](../../../05%20-%20Standards/rfcs/RFC-009-zone-control-and-config.md) — K82 forbidden-secret failure mode.
