...
**Source specs**: [KB-notebook-target.md §3](../../../03%20-%20Blueprint/KB-notebook-target.md#3-the-central-architectural-split) (the central architectural split), [BSP-002 §2](../../../03%20-%20Blueprint/BSP-002-conversation-graph.md#2-data-modelgit-for-the-notebooks-turn-dag) (data model — git for the turn DAG), [BSP-002 §12](../../../03%20-%20Blueprint/BSP-002-conversation-graph.md#12-overlays--operator-edits-as-a-second-git-style-graph) (overlays — second git-style graph), [BSP-007 §1](../../../03%20-%20Blueprint/BSP-007-overlay-git-semantics.md#1-scope) (overlay above immutable DAG)
...
This is the [Maya animation layers / Photoshop layers / Scratch source-vs-sprite](../../../03%20-%20Blueprint/BSP-002-conversation-graph.md#128-why-this-is-the-right-shape-game-dev-rationale) game-dev rationale (BSP-002 §12.8): source pixels + edit layers, each with their own history, composed at render time.
