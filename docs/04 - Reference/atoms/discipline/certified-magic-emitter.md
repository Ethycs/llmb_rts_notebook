...
**Source specs**: [PLAN-S5.0.1 §3.3](../../../06%20-%20Roadmaps/PLAN-S5.0.1-cell-magic-injection-defense.md#33-output-sanitizer-wrapper--vendorllmkernelllm_kernelsocket_writerpy-modest) (the emission-ban chokepoint this standard inverts), [PLAN-S5.0.1 §3.7](../../../06%20-%20Roadmaps/PLAN-S5.0.1-cell-magic-injection-defense.md#37-cell-manager-re-stamping) (`restamp_with_pin` as a certified emitter), [PLAN-S5.0 §3.8](../../../06%20-%20Roadmaps/PLAN-S5.0-cell-magic-vocabulary.md#38-cell-manager-text-operations--vendorllmkernelllm_kernelcell_managerpy-new-80-loc) (Cell Manager text primitives), [PLAN-S5.0.2](../../../06%20-%20Roadmaps/PLAN-S5.0.2-magic-code-generators.md) (generator handlers, queued)
...
| Magic code generator handlers (V1 shipped, S5.0.2) | `@@template` / `@@expand` / `@@import` per [PLAN-S5.0.2](../../../06%20-%20Roadmaps/PLAN-S5.0.2-magic-code-generators.md) | new cells inserted after the generator cell | `emit_magic_line()`; mandatory `generated_by` provenance |
...
The kernel's emission ban remains non-negotiable on the prose surface, even for privileged agents; the operator's only escape hatch from the ban itself is the verbatim acceptance string per [PLAN-S5.0.1 §3.11](../../../06%20-%20Roadmaps/PLAN-S5.0.1-cell-magic-injection-defense.md#311-refusal-flag--verbatim-injection-acceptance), which doesn't certify anything — it merely records that the operator has opted out of protection.

## V1 vs V2+

- **V1 (post-S5.0.1)**: operator typing, Cell Manager primitives, `restamp_with_pin`, writer serializer.
- **V1 (post-S5.0.2)**: generator handlers ship per [PLAN-S5.0.2](../../../06%20-%20Roadmaps/PLAN-S5.0.2-magic-code-generators.md).
...
- [PLAN-S5.0.1](../../../06%20-%20Roadmaps/PLAN-S5.0.1-cell-magic-injection-defense.md) — defines `restamp_with_pin`, `emit_magic_line()`, the emission-ban sanitizer, and K3A/K3I/K3J
- [PLAN-S5.0.2](../../../06%20-%20Roadmaps/PLAN-S5.0.2-magic-code-generators.md) — queued slice for generator handlers
