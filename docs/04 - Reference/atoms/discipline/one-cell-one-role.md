...
**Source specs**: [KB-notebook-target.md §13.1](../../../03%20-%20Blueprint/KB-notebook-target.md#131-one-cell-one-system-role) (one cell, one system role), [KB-notebook-target.md §22.1](../../../03%20-%20Blueprint/KB-notebook-target.md#221-splitmerge-invariants) (provenance domains), [BSP-002 §13.4](../../../03%20-%20Blueprint/BSP-002-conversation-graph.md#134-tool-calls-live-in-their-parent-turn-kb-target-03) (tool calls in parent turn)
