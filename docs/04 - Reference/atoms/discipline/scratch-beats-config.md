...
**Source specs**: [KB-notebook-target.md §7](../../../03%20-%20Blueprint/KB-notebook-target.md#7-scope-control) (scope control discipline), [KB-notebook-target.md §13.4](../../../03%20-%20Blueprint/KB-notebook-target.md#134-scratch-is-notebook-level-not-hidden-configuration) (scratch is notebook-level), [KB-notebook-target.md §13.5](../../../03%20-%20Blueprint/KB-notebook-target.md#135-no-super-complex-configuration-in-v1) (no super-complex config)
