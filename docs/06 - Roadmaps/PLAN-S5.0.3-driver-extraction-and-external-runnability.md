...
- [docs/rfcs/RFC-001-mcp-tool-taxonomy.md](../05%20-%20Standards/rfcs/RFC-001-mcp-tool-taxonomy.md) — tool schemas being promoted to public API
- [docs/rfcs/RFC-006-kernel-extension-wire-format.md](../05%20-%20Standards/rfcs/RFC-006-kernel-extension-wire-format.md) — wire format being amended in Round 0
- [docs/rfcs/RFC-008-pty-transport.md](../05%20-%20Standards/rfcs/RFC-008-pty-transport.md) — current transport that TCP joins
- [docs/atoms/discipline/sub-agent-dispatch.md](../04%20-%20Reference/atoms/discipline/sub-agent-dispatch.md) — dispatch methodology this slice uses
- [docs/atoms/discipline/zachtronics.md](../04%20-%20Reference/atoms/discipline/zachtronics.md) — visible-tile principle (CLI surface honors it: every flag visible, no hidden config)
