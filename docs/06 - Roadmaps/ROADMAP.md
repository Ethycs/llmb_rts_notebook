...
1. **When does V1 stamp a release SHA?** — Rows 1-11 of [PLAN-v1-roadmap §5](../07%20-%20Status%20Reports/PLAN-v1-roadmap.md) are ✅; row 13 (substrate gaps) needs a focused verification pass against `PLAN-substrate-gap-closure §3`; row 14 (atom drift) needs a full detector run. Once those land, the V1 SHA is justified.
