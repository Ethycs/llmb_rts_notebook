...
2. **Cells need a typed, scriptable text representation** — the [discipline/zachtronics](../04%20-%20Reference/atoms/discipline/zachtronics.md) atom and [KB-notebook-target.md §13](../03%20-%20Blueprint/KB-notebook-target.md#13-cell-discipline-zachtronics-not-general-asm) commit to "tiles, not assembly": every cell has a single visible role; reading the notebook top-to-bottom predicts behavior. Without a uniform tile-declaration syntax, the kind invariant from [concepts/cell-kinds](../04%20-%20Reference/atoms/concepts/cell-kinds.md) and the flag invariants from [pin-exclude-scratch-checkpoint](../04%20-%20Reference/atoms/operations/pin-exclude-scratch-checkpoint.md) live in cell metadata fields the operator can't see in the source.
...
- No partial-handoff strategies (drop-oldest, summarize) when missed-turn count exceeds budget. V2+ per [continue-turn](../04%20-%20Reference/atoms/operations/continue-turn.md) §"V1 vs V2+".
...
- No conditionals or control flow. Per [discipline/zachtronics](../04%20-%20Reference/atoms/discipline/zachtronics.md) — visible tile order is the flow.
...
| `@@tool <name>` | V2+ reserved — round-trips, renders inert per [cell-kinds](../04%20-%20Reference/atoms/concepts/cell-kinds.md) |
...
| `@handoff <id>` | sets `cell.line_magics`; on cell run, edits NEXT cell's `bound_agent_id` + `inherit_context_from` per [decisions/v1-section-status-interruptibility](../04%20-%20Reference/atoms/decisions/v1-section-status-interruptibility.md) sibling design |
...
The Cell Manager façade per [discipline/cell-manager-owns-structure](../04%20-%20Reference/atoms/discipline/cell-manager-owns-structure.md) gains text-mutation primitives:
...
- [concepts/cell](../04%20-%20Reference/atoms/concepts/cell.md) — schema collapses to `{ text, outputs, bound_agent_id }`; kind/flags become parse-derived
- [concepts/cell-kinds](../04%20-%20Reference/atoms/concepts/cell-kinds.md) — kind discriminator is `@@<magic>` line at top of cell
- [discipline/cell-manager-owns-structure](../04%20-%20Reference/atoms/discipline/cell-manager-owns-structure.md) — Cell Manager text-mutation primitives are now the structural API
- [operations/spawn-agent](../04%20-%20Reference/atoms/operations/spawn-agent.md) — canonical form is `@@spawn <id>`; `/spawn` is a column-0 alias
- [operations/continue-turn](../04%20-%20Reference/atoms/operations/continue-turn.md) — canonical form is `@@agent <id>`; `@<id>:` is a column-0 alias
- [operations/pin-exclude-scratch-checkpoint](../04%20-%20Reference/atoms/operations/pin-exclude-scratch-checkpoint.md) — flags toggled via `@<line_magic>` in cell text
- [protocols/operator-action](../04%20-%20Reference/atoms/protocols/operator-action.md) — `agent_spawn`, `agent_continue`, `set_cell_metadata` envelope shapes now sourced from magic-parser output

---

## §8. Cross-references

- [BSP-005 §S5](../03%20-%20Blueprint/BSP-005-cell-roadmap.md) — branch/revert/stop become `@<line_magic>` forms after this slice
- [BSP-005 §S5.5](../03%20-%20Blueprint/BSP-005-cell-roadmap.md) — sections become `@@section <name>` cell magic
- [BSP-005 §S6](../03%20-%20Blueprint/BSP-005-cell-roadmap.md) — cell-to-turn binding writes to `cells[<id>].text` (canonical) instead of separate fields
...
- [discipline/zachtronics](../04%20-%20Reference/atoms/discipline/zachtronics.md) — the visible-tile principle this slice operationalizes
- [KB-notebook-target.md §13](../03%20-%20Blueprint/KB-notebook-target.md#13-cell-discipline-zachtronics-not-general-asm) — the design doctrine
