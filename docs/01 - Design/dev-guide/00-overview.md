...
what was rejected), see [the ADR index](../../02%20-%20Implementation/decisions/README.md). For
...
[docs/decisions/](../../02%20-%20Implementation/decisions/). The ADR records what was
