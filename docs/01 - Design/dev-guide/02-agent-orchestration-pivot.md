...
This pivot is recorded as **DR-0001** (see [docs/decisions/](../../02%20-%20Implementation/decisions/)).
...
This pivot is recorded as **DR-0002** (see [docs/decisions/](../../02%20-%20Implementation/decisions/)). It is the first place in the project where an architecturally significant assumption from earlier in the same phase gets cleanly retired in favor of a better-fitting one.
