...
Each §0.x decision now lives as a dedicated atom under [`docs/atoms/decisions/`](../04%20-%20Reference/atoms/decisions/). The subsections below collapse to the canonical link.
...
See [concepts/section.md](../04%20-%20Reference/atoms/concepts/section.md) and [concepts/zone.md](../04%20-%20Reference/atoms/concepts/zone.md) for the canonical definitions of each.

### 0.2 Sub-turns are merge artifacts, not fundamental

See [decisions/v1-no-nesting.md](../04%20-%20Reference/atoms/decisions/v1-no-nesting.md) and [concepts/sub-turn.md](../04%20-%20Reference/atoms/concepts/sub-turn.md).

### 0.3 Tool calls live in their parent turn

See [discipline/tool-calls-atomic.md](../04%20-%20Reference/atoms/discipline/tool-calls-atomic.md) and [concepts/tool-call.md](../04%20-%20Reference/atoms/concepts/tool-call.md).

### 0.4 Cell kinds typed in V1

See [concepts/cell-kinds.md](../04%20-%20Reference/atoms/concepts/cell-kinds.md).

### 0.5 RunFrames — minimal V1 schema

See [decisions/v1-runframe-minimal.md](../04%20-%20Reference/atoms/decisions/v1-runframe-minimal.md) and [concepts/run-frame.md](../04%20-%20Reference/atoms/concepts/run-frame.md).

### 0.6 ContextPacker — simple V1 contract

See [decisions/v1-contextpacker-walk.md](../04%20-%20Reference/atoms/decisions/v1-contextpacker-walk.md) and [concepts/context-manifest.md](../04%20-%20Reference/atoms/concepts/context-manifest.md).

### 0.7 Capabilities — V2

See [decisions/capabilities-deferred-v2.md](../04%20-%20Reference/atoms/decisions/capabilities-deferred-v2.md).

### 0.8 Typed outputs — V1 ships the tag, V2 ships lenses

See [decisions/v1-output-kind-tag.md](../04%20-%20Reference/atoms/decisions/v1-output-kind-tag.md) and [concepts/output-kind.md](../04%20-%20Reference/atoms/concepts/output-kind.md).

### 0.9 Artifacts — V1 ships the shape, V2 ships streaming

See [decisions/v1-artifact-shape.md](../04%20-%20Reference/atoms/decisions/v1-artifact-shape.md) and [concepts/artifact-ref.md](../04%20-%20Reference/atoms/concepts/artifact-ref.md).
...
- **S4 cross-agent context handoff** shipped (`fe2121a`). Per BSP-002 §4.6; replays missing turns through agents via [context-manifest atom](../04%20-%20Reference/atoms/concepts/context-manifest.md). See [PLAN-S4-cross-agent-handoff.md](../07%20-%20Status%20Reports/PLAN-S4-cross-agent-handoff.md).
- **S5.0 cell-magic vocabulary** + **S5.0.1 injection defenses** shipped. Replaces the legacy `/spawn` / `@<id>:` directive grammar with `@@<kind>` cell-magic + `@<flag>` line-magic. The cell schema collapsed to `{text, outputs, bound_agent_id}` with kind/flags now parse-derived from `text`. See [PLAN-S5.0-cell-magic-vocabulary.md](../07%20-%20Status%20Reports/PLAN-S5.0-cell-magic-vocabulary.md), [magic atom](../04%20-%20Reference/atoms/concepts/magic.md), [discipline/text-as-canonical](../04%20-%20Reference/atoms/discipline/text-as-canonical.md), [discipline/certified-magic-emitter](../04%20-%20Reference/atoms/discipline/certified-magic-emitter.md).
- **S5.0.3.x headless executor** shipped (TCP transport + handshake envelope per RFC-006 v2.1.0 + RFC-008 v1.0.1; smoke driver `73c6940`; live-mode `27c0fcc`). See [PLAN-S5.0.3.1-executor-live-mode.md](../07%20-%20Status%20Reports/PLAN-S5.0.3.1-executor-live-mode.md), [protocols/wire-handshake atom](../04%20-%20Reference/atoms/protocols/wire-handshake.md), [concepts/transport-mode atom](../04%20-%20Reference/atoms/concepts/transport-mode.md).
- **S5c-stop** in flight on `vendor/LLMKernel @ wip/s5c-stop`; not yet on main.

Section-status interruptibility lock supersedes original D1 row in [PLAN-atom-refactor.md §4](../07%20-%20Status%20Reports/PLAN-atom-refactor.md#4-the-24-v1-decisions-to-land-in-decisions-atoms) (`section.status` ships in V1 as the structural-op gate; see [decisions/v1-section-status-interruptibility](../04%20-%20Reference/atoms/decisions/v1-section-status-interruptibility.md)).
...
Each noun above has a canonical atom under [`docs/atoms/concepts/`](../04%20-%20Reference/atoms/concepts/).
...
This is the architectural foundation. The discipline that makes it work is captured in [discipline/immutability-vs-mutability.md](../04%20-%20Reference/atoms/discipline/immutability-vs-mutability.md).

For the canonical definitions of the nouns above see [concepts/turn.md](../04%20-%20Reference/atoms/concepts/turn.md), [concepts/cell.md](../04%20-%20Reference/atoms/concepts/cell.md), [concepts/overlay-commit.md](../04%20-%20Reference/atoms/concepts/overlay-commit.md).

---

## 4. What a cell is

See [concepts/cell.md](../04%20-%20Reference/atoms/concepts/cell.md) for the definition. The remainder of this section is the operator-narrative for cell-as-issuance-unit.
...
A cell may contain multiple sub-turns (post-merge — see [concepts/sub-turn.md](../04%20-%20Reference/atoms/concepts/sub-turn.md) and [decisions/v1-no-nesting.md](../04%20-%20Reference/atoms/decisions/v1-no-nesting.md) for why sub-turns appear only as merge artifacts in V1):
...
For the operations themselves see [operations/split-cell.md](../04%20-%20Reference/atoms/operations/split-cell.md) and [operations/merge-cells.md](../04%20-%20Reference/atoms/operations/merge-cells.md). The structural authority is captured in [discipline/cell-manager-owns-structure.md](../04%20-%20Reference/atoms/discipline/cell-manager-owns-structure.md).
...
See [concepts/section.md](../04%20-%20Reference/atoms/concepts/section.md) and [concepts/zone.md](../04%20-%20Reference/atoms/concepts/zone.md) for the definitions and the rename rationale (the operator-narrative concept this section formerly called "Zone" is named **Section** in implementation per §0.1).
...
This preserves the Zachtronics-style discipline (see [discipline/zachtronics.md](../04%20-%20Reference/atoms/discipline/zachtronics.md) and [discipline/scratch-beats-config.md](../04%20-%20Reference/atoms/discipline/scratch-beats-config.md)): visible pieces, simple roles, local movement, and emergent global behavior.
...
Several of these have canonical operation atoms: [continue-turn](../04%20-%20Reference/atoms/operations/continue-turn.md), [branch-agent](../04%20-%20Reference/atoms/operations/branch-agent.md), [revert-agent](../04%20-%20Reference/atoms/operations/revert-agent.md), [stop-agent](../04%20-%20Reference/atoms/operations/stop-agent.md), [promote-span](../04%20-%20Reference/atoms/operations/promote-span.md), [pin-exclude-scratch-checkpoint](../04%20-%20Reference/atoms/operations/pin-exclude-scratch-checkpoint.md).
...
Each run receives a RunFrame — see [concepts/run-frame.md](../04%20-%20Reference/atoms/concepts/run-frame.md) for the canonical schema.
...
See [concepts/agent.md](../04%20-%20Reference/atoms/concepts/agent.md) for the canonical definition.
...
See [concepts/tool-call.md](../04%20-%20Reference/atoms/concepts/tool-call.md) for the canonical definition of an individual tool call.
...
The ISA metaphor is useful only if it produces discipline. See [discipline/zachtronics.md](../04%20-%20Reference/atoms/discipline/zachtronics.md) for the canonical rule.
...
For the canonical cell-kinds enumeration see [concepts/cell-kinds.md](../04%20-%20Reference/atoms/concepts/cell-kinds.md). For the rule itself see [discipline/one-cell-one-role.md](../04%20-%20Reference/atoms/discipline/one-cell-one-role.md).
...
See [discipline/scratch-beats-config.md](../04%20-%20Reference/atoms/discipline/scratch-beats-config.md) for the canonical rule.
...
The flag-toggle operations themselves live in [operations/pin-exclude-scratch-checkpoint.md](../04%20-%20Reference/atoms/operations/pin-exclude-scratch-checkpoint.md).
...
For the canonical sub-turn addressing convention (`cell:c_17.2`) see [concepts/sub-turn.md](../04%20-%20Reference/atoms/concepts/sub-turn.md).

---

## 15. Typed outputs

See [concepts/output-kind.md](../04%20-%20Reference/atoms/concepts/output-kind.md) for the canonical enumeration.
...
See [concepts/artifact-ref.md](../04%20-%20Reference/atoms/concepts/artifact-ref.md) for the canonical schema and the V1 inline-body / V2 streaming distinction.
...
This notebook should persist explicit state and make volatile state inspectable. The save discipline is captured in [discipline/save-is-git-style.md](../04%20-%20Reference/atoms/discipline/save-is-git-style.md).

---

## 20. Security and capabilities

Capabilities are deferred to V2 for the single-operator case (see [decisions/capabilities-deferred-v2.md](../04%20-%20Reference/atoms/decisions/capabilities-deferred-v2.md)). The target shape:
...
This section is the canonical merge-correctness rule. The operation atoms ([operations/merge-cells.md](../04%20-%20Reference/atoms/operations/merge-cells.md), [operations/split-cell.md](../04%20-%20Reference/atoms/operations/split-cell.md)) and BSP-007 §6 cite this section as the source of truth.

### 22.2 ContextPacker algorithm

The V1 contract is pinned in [decisions/v1-contextpacker-walk.md](../04%20-%20Reference/atoms/decisions/v1-contextpacker-walk.md); the algorithm is implemented in BSP-008 §3. The output schema is [concepts/context-manifest.md](../04%20-%20Reference/atoms/concepts/context-manifest.md).
