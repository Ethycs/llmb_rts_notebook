...
**Purpose**: navigation surface only. Definitions live in [docs/atoms/](../04%20-%20Reference/atoms/). Behavior + wire formats live in the relevant BSP / RFC. This doc is a pointer index — when a section says "see X," go there.
...
| What a cell IS (data model) | [atoms/concepts/cell](../04%20-%20Reference/atoms/concepts/cell.md) + [BSP-002 §3](BSP-002-conversation-graph.md#3-cell-directive-grammar) |
| Cell types (kinds enum) | [atoms/concepts/cell-kinds](../04%20-%20Reference/atoms/concepts/cell-kinds.md) |
| Sections (operator narrative range) | [atoms/concepts/section](../04%20-%20Reference/atoms/concepts/section.md) |
| Turns (immutable agent truth) | [atoms/concepts/turn](../04%20-%20Reference/atoms/concepts/turn.md) |
| Sub-turns (merge artifact) | [atoms/concepts/sub-turn](../04%20-%20Reference/atoms/concepts/sub-turn.md) |
| Spans + tool calls + atomicity | [atoms/concepts/span](../04%20-%20Reference/atoms/concepts/span.md), [atoms/concepts/tool-call](../04%20-%20Reference/atoms/concepts/tool-call.md), [atoms/discipline/tool-calls-atomic](../04%20-%20Reference/atoms/discipline/tool-calls-atomic.md) |
| Cell lifecycle (spawn → continue → branch → revert → save → reopen) | [atoms/operations/](../04%20-%20Reference/atoms/operations/) + [BSP-002 §4](BSP-002-conversation-graph.md#4-persistent-agent-lifecycle) |
| Cell-to-agent binding, identity rendering | [atoms/concepts/agent](../04%20-%20Reference/atoms/concepts/agent.md) + [BSP-002 §6](BSP-002-conversation-graph.md#6-cell-as-agent-issuance-scope) + [BSP-005 S1](BSP-005-cell-roadmap.md) |
| Cell directive grammar | [BSP-002 §3](BSP-002-conversation-graph.md#3-cell-directive-grammar) + the operations atoms |
| Cross-agent context handoff | [BSP-002 §4.6](BSP-002-conversation-graph.md#46-cross-agent-context-handoff) + [atoms/concepts/context-manifest](../04%20-%20Reference/atoms/concepts/context-manifest.md) |
| Persistence — saving and reopening | [RFC-005](../05%20-%20Standards/rfcs/RFC-005-llmnb-file-format.md) + [RFC-006 §8](../05%20-%20Standards/rfcs/RFC-006-kernel-extension-wire-format.md) + [atoms/discipline/save-is-git-style](../04%20-%20Reference/atoms/discipline/save-is-git-style.md) |
...
| Topic | Atoms | Spec |
|---|---|---|
| Data model — cells, turns, agents, sections, sub-turns | [cell](../04%20-%20Reference/atoms/concepts/cell.md), [turn](../04%20-%20Reference/atoms/concepts/turn.md), [agent](../04%20-%20Reference/atoms/concepts/agent.md), [section](../04%20-%20Reference/atoms/concepts/section.md), [sub-turn](../04%20-%20Reference/atoms/concepts/sub-turn.md), [zone](../04%20-%20Reference/atoms/concepts/zone.md), [span](../04%20-%20Reference/atoms/concepts/span.md), [blob](../04%20-%20Reference/atoms/concepts/blob.md), [artifact-ref](../04%20-%20Reference/atoms/concepts/artifact-ref.md) | [BSP-002 §2-§3](BSP-002-conversation-graph.md), [RFC-005](../05%20-%20Standards/rfcs/RFC-005-llmnb-file-format.md) |
| Cell types | [cell-kinds](../04%20-%20Reference/atoms/concepts/cell-kinds.md) | [BSP-002 §13.2](BSP-002-conversation-graph.md) |
| Lifecycle ops | [spawn-agent](../04%20-%20Reference/atoms/operations/spawn-agent.md), [continue-turn](../04%20-%20Reference/atoms/operations/continue-turn.md), [branch-agent](../04%20-%20Reference/atoms/operations/branch-agent.md), [revert-agent](../04%20-%20Reference/atoms/operations/revert-agent.md), [stop-agent](../04%20-%20Reference/atoms/operations/stop-agent.md) | [BSP-002 §4](BSP-002-conversation-graph.md#4-persistent-agent-lifecycle), [BSP-005 S2-S5](BSP-005-cell-roadmap.md) |
| Cell-as-agent identity rendering | [agent](../04%20-%20Reference/atoms/concepts/agent.md), [cell](../04%20-%20Reference/atoms/concepts/cell.md) | [BSP-002 §6](BSP-002-conversation-graph.md), [BSP-005 S1](BSP-005-cell-roadmap.md) |
| Directive grammar | (no atom — grammar is BSP-002 §3) | [BSP-002 §3](BSP-002-conversation-graph.md#3-cell-directive-grammar) |
| Cross-agent context handoff | [context-manifest](../04%20-%20Reference/atoms/concepts/context-manifest.md) | [BSP-002 §4.6](BSP-002-conversation-graph.md) |
| Persistence (save/hydrate) | [save-is-git-style](../04%20-%20Reference/atoms/discipline/save-is-git-style.md), [no-rebind-popen](../04%20-%20Reference/atoms/decisions/no-rebind-popen.md) | [RFC-005](../05%20-%20Standards/rfcs/RFC-005-llmnb-file-format.md), [RFC-006 §8](../05%20-%20Standards/rfcs/RFC-006-kernel-extension-wire-format.md) |
| Overlay commits & cell structural ops | [overlay-commit](../04%20-%20Reference/atoms/concepts/overlay-commit.md), [split-cell](../04%20-%20Reference/atoms/operations/split-cell.md), [merge-cells](../04%20-%20Reference/atoms/operations/merge-cells.md), [move-cell](../04%20-%20Reference/atoms/operations/move-cell.md), [promote-span](../04%20-%20Reference/atoms/operations/promote-span.md), [apply-overlay-commit](../04%20-%20Reference/atoms/operations/apply-overlay-commit.md), [cell-manager-owns-structure](../04%20-%20Reference/atoms/discipline/cell-manager-owns-structure.md) | [BSP-007](BSP-007-overlay-git-semantics.md) |
| Run framing & context | [context-manifest](../04%20-%20Reference/atoms/concepts/context-manifest.md), [run-frame](../04%20-%20Reference/atoms/concepts/run-frame.md), [v1-contextpacker-walk](../04%20-%20Reference/atoms/decisions/v1-contextpacker-walk.md), [v1-runframe-minimal](../04%20-%20Reference/atoms/decisions/v1-runframe-minimal.md) | [BSP-008](BSP-008-contextpacker-runframes.md) |
...
See [FSP-001](FSP-001-cells-to-openui.md), [FSP-002](FSP-002-cell-search-collapse.md), [BSP-002 §11](BSP-002-conversation-graph.md), [atoms/decisions/capabilities-deferred-v2](../04%20-%20Reference/atoms/decisions/capabilities-deferred-v2.md), [atoms/decisions/asgi-deferred](../04%20-%20Reference/atoms/decisions/asgi-deferred.md).
...
See [atoms/anti-patterns/](../04%20-%20Reference/atoms/anti-patterns/) — RLock-on-logging, workspace-shadows-global, BSP-004 retrospective, Windows FD inheritance, PATH propagation, stub-kernel-race, secret-redaction, mitmdump-discovery.
...
If you're picking up the project later, browse [docs/atoms/](../04%20-%20Reference/atoms/) by category and follow links into the specs cited.

---

## Changelog

- **2026-04-28**: reborn as ref-only navigation index. Drops prose definitions in §2-§11 + §13 (now in [docs/atoms/](../04%20-%20Reference/atoms/)); keeps §1 narrative, §12 open questions, §15 chronology as the unique illustrative/historical content. 201 lines vs original 434. Promoted from empirical A/B/C test in `docs/_ab-test/`.
