...
The V1 contract is pinned in [decisions/v1-contextpacker-walk.md](../04%20-%20Reference/atoms/decisions/v1-contextpacker-walk.md); the algorithm below is the implementation. Per KB-target §0.6, V1 is a deterministic structural-only walk. No ranking, no budget overflow, no summary trust.
...
See [context-manifest atom](../04%20-%20Reference/atoms/concepts/context-manifest.md) for the schema and invariants. The V1 fields are listed below for the kernel implementer's convenience.
...
See [run-frame atom](../04%20-%20Reference/atoms/concepts/run-frame.md) for the schema and invariants (and [decisions/v1-runframe-minimal.md](../04%20-%20Reference/atoms/decisions/v1-runframe-minimal.md) for the V1 minimal-shape decision). Per KB-target §0.5, V1 ships:
