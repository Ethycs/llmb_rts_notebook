...
Operations are documented as atoms under [docs/atoms/operations/](../04%20-%20Reference/atoms/operations/). Each atom carries the operation's contract, signature, invariants, and decision-row mappings (D/S/M/SD/CK).

Quick index of overlay-commit operations:

- [apply-overlay-commit](../04%20-%20Reference/atoms/operations/apply-overlay-commit.md) — the primitive that lands a commit
- [revert-overlay-commit](../04%20-%20Reference/atoms/operations/revert-overlay-commit.md) — rewind HEAD
- [create-overlay-ref](../04%20-%20Reference/atoms/operations/create-overlay-ref.md) — named refs (V1 tags)
- [split-cell](../04%20-%20Reference/atoms/operations/split-cell.md)
- [merge-cells](../04%20-%20Reference/atoms/operations/merge-cells.md)
- [move-cell](../04%20-%20Reference/atoms/operations/move-cell.md)
- [promote-span](../04%20-%20Reference/atoms/operations/promote-span.md)
- [pin-exclude-scratch-checkpoint](../04%20-%20Reference/atoms/operations/pin-exclude-scratch-checkpoint.md) — the four flag-toggle ops, collected
- [create-section](../04%20-%20Reference/atoms/operations/create-section.md)
- [delete-section](../04%20-%20Reference/atoms/operations/delete-section.md)
- [rename-section](../04%20-%20Reference/atoms/operations/rename-section.md)
...
Operations referenced below are defined as atoms under [docs/atoms/operations/](../04%20-%20Reference/atoms/operations/). The four primitives on the overlay graph itself follow.
...
The applier also stamps **writer-owned** fields `merged_from: [cell_b]` and `sub_turn_addressing: True` on `cell_a`. These persist in `metadata.rts.cells[cell_a]` so Inspect mode can surface merge provenance in O(1) without walking `commits[]`. See [merge-cells atom §"Writer-owned metadata stamps"](../04%20-%20Reference/atoms/operations/merge-cells.md#writer-owned-metadata-stamps-v1-decision--writer-owned) for the full ownership rationale.
