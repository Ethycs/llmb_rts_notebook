...
- [docs/atoms/concepts/magic-code-generator.md](../04%20-%20Reference/atoms/concepts/magic-code-generator.md) — the concept atom (Status flips to shipped on slice landing)
- [docs/atoms/discipline/cell-manager-owns-structure.md](../04%20-%20Reference/atoms/discipline/cell-manager-owns-structure.md) — why generators write through Cell Manager, not output stream
- [docs/atoms/discipline/zachtronics.md](../04%20-%20Reference/atoms/discipline/zachtronics.md) — visible-tile principle generators preserve
- [docs/atoms/discipline/sub-agent-dispatch.md](../04%20-%20Reference/atoms/discipline/sub-agent-dispatch.md) — dispatch methodology (kernel + extension as file-disjoint pair)
